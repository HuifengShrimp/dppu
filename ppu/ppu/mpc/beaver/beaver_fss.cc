...
BeaverFss::BeaverFss(std::shared_ptr<link::Context> lctx)
...
Beaver::Triple BeaverFss::Mul(FieldType field, size_t size) {
...
Beaver::Triple BeaverFss::Dot(FieldType field, size_t M, size_t N, size_t K) {
  std::vector<PrgArrayDesc> descs(3);
...
Beaver::LR_set BeaverFss::lr(FieldType field, size_t M, size_t N){
...
Beaver::Triple BeaverFss::And(FieldType field, size_t size) {
  std::vector<PrgArrayDesc> descs(3);
...
Beaver::Pair BeaverFss::Trunc(FieldType field, size_t size, size_t bits) {
...
ArrayRef BeaverFss::RandBit(FieldType field, size_t size) {
  PrgArrayDesc desc{};
