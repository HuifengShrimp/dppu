...
#include "ppu/mpc/dealer/dealer_tfp.h"
...
Dealer::Triple DealerTfp::Mul(FieldType field, size_t size) {
...
Dealer::Triple DealerTfp::Dot(FieldType field, size_t M, size_t N, size_t K) {
  std::vector<PrgArrayDesc> descs(3);
...
Dealer::LR_set DealerTfp::lr(FieldType field, size_t M, size_t N){
...
Dealer::Triple DealerTfp::And(FieldType field, size_t size) {
  std::vector<PrgArrayDesc> descs(3);
...
Dealer::Pair DealerTfp::Trunc(FieldType field, size_t size, size_t bits) {
...
ArrayRef DealerTfp::RandBit(FieldType field, size_t size) {
  PrgArrayDesc desc{};
